Instructions for upgrading jquery & jquery UI to the latest version.
...
- Download latest jquery UI concatenated JS & CSS zip (jquery-ui-x.x.x.zip) from
  ...
  static/js/vendor/jquery/ui/x.x.x directory:
        ...
        all .js files
        all .css files (don't copy jquery-ui.theme.css or jquery-ui.theme.min.css, as these will
        will conflict once the theme files are installed in the next step)
